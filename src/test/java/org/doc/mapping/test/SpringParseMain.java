...
public class SpringParseMain {
	...
	public static void main(String[] args) {
		...
		DocMappingParser baseImport= (DocMappingParser)applicationContext.getBean("baseImport");
		DocMappingParser advancedImport= (DocMappingParser)applicationContext.getBean("advancedImport");
		DocMappingParser importWithoutColumnName= (DocMappingParser)applicationContext.getBean("importWithoutColumnName");
		DocMappingParser importTextFile= (DocMappingParser)applicationContext.getBean("importTextFile");
		//测试没有header的文件解析
